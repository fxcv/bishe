...
EXPERIMENT_NAME = "macbert_chnsenticorp"
...
os.environ["TRANSFORMERS_OFFLINE"] = "1"  # 加这个！
...
def save_test_result(trainer: Trainer, test_df: pd.DataFrame, tokenizer, train_seconds: float):
    ...
    with open(RESULT_TXT, "w", encoding="utf-8") as f:
        f.write("ChnSentiCorp 测试集结果（MacBERT）\n")
